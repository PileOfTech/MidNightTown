      ...
      $stateProvider
        ...
        .state('price_list_path', {
          ...
          templateUrl: function(params) {
            ...
            return Routes['price_list_path'](params);
          },
          controller: 'GenresCtrl as ctrl',
          resolve: {
            action: ['$stateParams', function ($stateParams) {
              return resolve('price_list', $stateParams)
            }]
          }
        })
...
angular.module("oxymoron.services.resources", [])
  .factory('resourceDecorator', [function () {
    ...
    .factory('Image', ['$resource', 'resourceDecorator', function ($resource, resourceDecorator) {
      return resourceDecorator($resource('/images/:id.json', {"id":"@id"}, {
        "new": {
          "method": "GET",
          "url": "/images/:id/new.json"
        },
        "edit": {
          "method": "GET",
          "url": "/images/:id/edit.json"
        },
        "update": {
          "method": "PUT"
        },
